/** -----------------------
 ...
 const docSlider = (function () {
    ...
    const op = {
        ...
        setChangeCss (index, currentIndex, speed, easing, horizontal) {
    ...
    const u = {
        ...
        pageChange(to){
            ...
            const speed  = d.speed  === null ? op.speed  : d.speed;
            ...
            if(!speed){
                ...
                if(sc)
                    window.scrollCue._updateWithDocSlider();
        ...
        animationReset (index){

            const selector = '[data-scpage][data-show="true"]'
            ...
            window.scrollCue._searchElements();
    ...
    return {
        ...
        init (options) {
            ...
            f.setData();
            f.setEvent();
            const startHash = f.hashJump();

            sc = typeof window.scrollCue === 'undefined' ? false : window.scrollCue._hasDocSlider();
            pcr = typeof window.scrollCue === 'undefined' ? false : window.scrollCue._hasPageChangeReset();

            if(sc){

                window.scrollCue._initWithDocSlider(startHash);
